...
export class LoginService {
  ...
  updatePassword(login:any):Observable<string> {
    return this.http.patch(this.baseURL+"/updatepwd",login,{responseType:"text"});
  }
  updateProfile(login:any):Observable<string> {
    return this.http.patch(this.baseURL+"/updateprofile",login,{responseType:"text"});
  }
